...
testMask_dir = "/Users/nam.le/Desktop/research/DTFD-MIL/data/mask"  ## Point to the Camelyon test set mask location
...
parser.add_argument(
    "--mDATA0_dir_train0",
    default="/Users/nam.le/Desktop/research/DTFD-MIL/data/mDATA_train_mini.pkl",
    type=str,
)  ## Train Set
parser.add_argument(
    "--mDATA0_dir_val0",
...
parser.add_argument(
    "--mDATA_dir_test0",
    default="/Users/nam.le/Desktop/research/DTFD-MIL/data/mDATA_test_mini.pkl",
    type=str,
)  ## Test Set
